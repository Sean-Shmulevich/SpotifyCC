...
local player -- Declare player as a global variable
local playerInitialized = false -- Flag to indicate player initialization

--drop the player and make a new one on pause
-- what about all of the data that is likely stored in the stream?
-- what about putting a funcion in where play audio calls dfpwm..
local function playAudio()
    player = aukit.play(iter, function(pos)
    ...
    playerInitialized = true -- Signal that player has been initialized
end

parallel.waitForAll(playAudio)
print()
